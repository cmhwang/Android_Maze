...
public interface DistanceSensor {
	...
	/**
	 * Returns the whether the sensor is down for repair
	 * @return whether sensor is currently down for repair
	 */
	boolean checkRepairStatus();
	...
	/**
	 * Returns what the sensor's type is based on a string
	 * Used to decide in state playing whether to start or stop the thread process
	 * @return a string unreliable or reliable to represent the type of robot 
	 */
	String getSensorType();
	
	/**
	 * Returns what the sensor's relative direction is 
	 * @return a relative direction to represent the sensor's relative direction 
	 */
	Direction getSensorRelativeDirection();
