 ...
 */
public class StatePlayingAnimated implements State {
    //activity object
    public PlayAnimationActivity activity;
...
//    private Control control;
    ...
    //new robot driver parameter moved from control
    public RobotDriver driver;

    //new robot parameter moved from control
    public Robot robot;
...
//            switchToTitle();
    ...
    /**
     * Helper method to set robot and driver for easier access
     * @param r is robot
     * @param d is driver
     */
