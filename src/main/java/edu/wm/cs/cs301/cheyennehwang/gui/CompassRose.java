...
import static edu.wm.cs.cs301.cheyennehwang.gui.ColorTheme.CIRCLE_SHADE;
...
public class CompassRose {
     ...
     */
    public CompassRose(MazePanel panel, double scaler, double markerRadius, String markerFont) {
        this.scaler = scaler;
