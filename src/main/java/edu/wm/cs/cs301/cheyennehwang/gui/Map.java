...
public class Map {
	...
	public void draw(int x, int y, int angle, int walkStep,
			boolean showMaze, boolean showSolution, MazePanel panel) {
	...
	private void drawMap(int px, int py, int walkStep,
			int viewDX, int viewDY, boolean showMaze, boolean showSolution, MazePanel panel) {
	 ...
	 * @param startY the y coordinate for drawing
	 */
	private void drawHorizontalLine(boolean showMaze, int x, int y, int startX,
	...
	private void drawArrow(int viewDX, int viewDY,
			final int startX, final int startY, MazePanel panel) {
